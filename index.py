...
def welcomeScreen():
    """
    Shows welcome images on the screen with a start button
    """
    ...
    # Button properties
    start_button_rect = pygame.Rect(SCREENWIDTH / 2 - 50, SCREENHEIGHT / 1.5, 100, 50)
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN and (event.key == K_SPACE or event.key == K_UP):
                return  # Start game on key press

            # Start button click event
            if event.type == MOUSEBUTTONDOWN:
                if start_button_rect.collidepoint(event.pos):
                    return  # Start game on button click
        ...
        SCREEN.blit(text, (start_button_rect.x + 20, start_button_rect.y + 10))
...
def gameOverScreen():
    """
    Shows game over screen with a restart button
    """

    font = pygame.font.SysFont('arial', 30)
    game_over_text = font.render('GAME OVER', True, (255, 0, 0))
    restart_button_rect = pygame.Rect(SCREENWIDTH / 2 - 50, SCREENHEIGHT / 1.5, 100, 50)
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN:
                if restart_button_rect.collidepoint(event.pos):
                    return  # Restart the game on button click

        SCREEN.blit(GAME_SPRITES['background'], (0, 0))
        SCREEN.blit(game_over_text, (SCREENWIDTH / 2 - 90, SCREENHEIGHT / 3))
        ...
        # Calculate text width and height to center it inside the button
        text_width, text_height = font.size('RESTART')
        text_x = restart_button_rect.x + (restart_button_rect.width - text_width) // 2
        text_y = restart_button_rect.y + (restart_button_rect.height - text_height) // 2
...
def mainGame():
    ...
    # "UP" button position
    up_button_rect = pygame.Rect(SCREENWIDTH / 2 - 50, SCREENHEIGHT - 80, 100, 50)
    ...
    while True:
        ...
        if crashTest:
            gameOverScreen()  # Show Game Over screen if the player crashes
            return
        ...
        # Draw "UP" Button
        pygame.draw.rect(SCREEN, (0, 0, 255), up_button_rect)
        font = pygame.font.SysFont('arial', 25)
        text = font.render('up', True, (255, 255, 255))
        SCREEN.blit(text, (up_button_rect.x + 30, up_button_rect.y + 10))

        myDigits = [int(x) for x in list(str(score))]
        width = 0
        for digit in myDigits:
            width += GAME_SPRITES['numbers'][digit].get_width()
        Xoffset = (SCREENWIDTH - width) / 1.1
        for digit in myDigits:
